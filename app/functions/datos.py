...
async def listar_dispositivos_datos(
...
async def reporte_dispositivos_datos(
    mes: Optional[int] = None,
    anio: Optional[int] = None,
) -> dict:
    m, y = _resolve_mes_anio(mes, anio)
...
async def reporte_dispositivos_datos_global(
    mes_desde: int,
    anio_desde: int,
    mes_hasta: int,
    anio_hasta: int,
...
async def buscar_comandos_datos(
